...
describe('InfoContainer', () => {
  describe('rendering', () => {
    it('renders the wrapper with correct class', () => {
      ...
      expect(container.querySelector('.mining-sdk-info-container')).toBeInTheDocument()
    })

    it('renders title with correct class', () => {
      render(<InfoContainer title="Model" />)

      expect(document.querySelector('.mining-sdk-info-container__title')).toBeInTheDocument()
    })

    it('renders value wrapper with correct class', () => {
      const { container } = render(<InfoContainer value="S19" />)

      expect(container.querySelector('.mining-sdk-info-container__value')).toBeInTheDocument()
    })
  })
  ...
  describe('title', () => {
    ...
    it('renders empty title when not provided', () => {
      ...
      const title = document.querySelector('.mining-sdk-info-container__title')
  ...
  describe('value — string', () => {
    ...
    it('renders a single div for a string value', () => {
      ...
      const valueWrapper = container.querySelector('.mining-sdk-info-container__value')
...
describe('DeviceInfo', () => {
  describe('rendering', () => {
    it('renders the wrapper with correct class', () => {
      ...
      expect(container.querySelector('.mining-sdk-device-info')).toBeInTheDocument()
    })

    it('renders nothing inside wrapper when data is undefined', () => {
      const { container } = render(<DeviceInfo />)

      const wrapper = container.querySelector('.mining-sdk-device-info')
    ...
    it('renders one InfoContainer per data item', () => {
      ...
      expect(container.querySelectorAll('.mining-sdk-info-container')).toHaveLength(3)
    })
  })
