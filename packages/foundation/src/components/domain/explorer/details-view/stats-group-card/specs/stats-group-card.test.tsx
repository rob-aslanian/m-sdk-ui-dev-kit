...
describe('StatsGroupCard', () => {
  ...
  describe('CSS classes', () => {
    it('applies correct wrapper class', () => {
      ...
      expect(container.querySelector('.mining-sdk-stats-group-card')).toBeInTheDocument()
    })
    ...
    it('applies correct row class', () => {
      ...
      expect(container.querySelector('.mining-sdk-stats-group-card__row')).toBeInTheDocument()
    })
    ...
    it('renders two rows for single device', async () => {
      ...
      await waitFor(() => {
        const rows = container.querySelectorAll('.mining-sdk-stats-group-card__row')
