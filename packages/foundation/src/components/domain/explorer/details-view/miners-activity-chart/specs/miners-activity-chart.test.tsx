...
describe('MinersActivityChart', () => {
  describe('error state', () => {
    ...
    it('does not render chart root when isError is true', () => {
      ...
      expect(
        container.querySelector('.mining-sdk-miners-activity-chart__root'),
  ...
  describe('chart rendering', () => {
    it('renders the chart root', () => {
      ...
      expect(container.querySelector('.mining-sdk-miners-activity-chart__root')).toBeInTheDocument()
    })
  ...
  describe('Indicator props', () => {
    ...
    it('applies large class when large is true', () => {
      ...
      indicators.forEach((indicator) => {
        expect(indicator).toHaveClass('mining-sdk-miners-activity-chart__item--large')
      })
    })
    ...
    it('does not apply large class when large is false', () => {
      ...
      screen.getAllByTestId('indicator').forEach((indicator) => {
        expect(indicator).not.toHaveClass('mining-sdk-miners-activity-chart__item--large')
      })
    })
  })
  ...
  describe('labels', () => {
    ...
    it('applies large label class when large is true', () => {
      ...
      expect(
        container.querySelector('.mining-sdk-miners-activity-chart__label--large'),
      ).toBeInTheDocument()
    })
    ...
    it('applies default label class when large is false', () => {
      ...
      expect(
        container.querySelector('.mining-sdk-miners-activity-chart__label'),
      ).toBeInTheDocument()
    })
  })
