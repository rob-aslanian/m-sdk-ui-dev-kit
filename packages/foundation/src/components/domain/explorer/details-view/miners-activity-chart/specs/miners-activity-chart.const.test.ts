...
describe('skeleton heights', () => {
  it('SKELETON_MIN_HEIGHT_LARGE is 120', () => {
    expect(SKELETON_MIN_HEIGHT_LARGE).toBe(120)
  })

  it('SKELETON_MIN_HEIGHT_DEFAULT is 80', () => {
    expect(SKELETON_MIN_HEIGHT_DEFAULT).toBe(80)
  })

  it('LARGE is greater than DEFAULT', () => {
    expect(SKELETON_MIN_HEIGHT_LARGE).toBeGreaterThan(SKELETON_MIN_HEIGHT_DEFAULT)
  })
})
