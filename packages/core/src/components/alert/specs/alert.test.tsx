...
describe('Alert', () => {
  describe('rendering', () => {
    ...
    it('renders the wrapper with base class', () => {
      ...
      expect(container.querySelector('.mining-sdk-alert')).toBeInTheDocument()
    })
  ...
  describe('type', () => {
    it('applies info class by default', () => {
      ...
      expect(container.querySelector('.mining-sdk-alert--info')).toBeInTheDocument()
    })
    ...
    it.each(['success', 'info', 'warning', 'error'] as const)(
      ...
      (type) => {
        ...
        expect(container.querySelector(`.mining-sdk-alert--${type}`)).toBeInTheDocument()
      },
    )
  })
  ...
  describe('title', () => {
    ...
    it('does not render title element when not provided', () => {
      ...
      expect(container.querySelector('.mining-sdk-alert__title')).not.toBeInTheDocument()
    })
  })
  ...
  describe('description', () => {
    ...
    it('does not render description element when not provided', () => {
      ...
      expect(container.querySelector('.mining-sdk-alert__description')).not.toBeInTheDocument()
    })

    it('applies with-description class when description is provided', () => {
      const { container } = render(<Alert description="desc" />)

      expect(container.querySelector('.mining-sdk-alert--with-description')).toBeInTheDocument()
    })

    it('does not apply with-description class without description', () => {
      const { container } = render(<Alert title="title" />)

      expect(container.querySelector('.mining-sdk-alert--with-description')).not.toBeInTheDocument()
    })
  })
  ...
  describe('icon', () => {
    it('does not render icon by default', () => {
      ...
      expect(container.querySelector('.mining-sdk-alert__icon')).not.toBeInTheDocument()
    })

    it('renders icon slot when showIcon is true', () => {
      const { container } = render(<Alert showIcon />)

      expect(container.querySelector('.mining-sdk-alert__icon')).toBeInTheDocument()
    })

    it('renders built-in SVG icon when showIcon is true and no custom icon', () => {
      const { container } = render(<Alert showIcon type="success" />)

      expect(container.querySelector('.mining-sdk-alert__icon svg')).toBeInTheDocument()
    })
  ...
  describe('banner', () => {
    it('does not apply banner class by default', () => {
      ...
      expect(container.querySelector('.mining-sdk-alert--banner')).not.toBeInTheDocument()
    })

    it('applies banner class when banner is true', () => {
      const { container } = render(<Alert banner />)

      expect(container.querySelector('.mining-sdk-alert--banner')).toBeInTheDocument()
    })
  })
  ...
  describe('action', () => {
    it('does not render action slot when not provided', () => {
      ...
      expect(container.querySelector('.mining-sdk-alert__action')).not.toBeInTheDocument()
    })
